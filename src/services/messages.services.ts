...
class MessageService {
  public async createMessage({ chat_id, sender_id, text, type, created_at, updated_at }: { chat_id: string, sender_id: string, text: string, type: MessageType, created_at: Date, updated_at: Date }) {
